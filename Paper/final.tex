...
\begin{figure}[t]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/balanced_tfidf_original_tsne.png}
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/balanced_ngrams_original_tsne.png}
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/balanced_word2vec_original_tsne.png}
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/balanced_glove_original_tsne.png}
